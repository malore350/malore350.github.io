class ProfileSidebar extends HTMLElement {
    ...
    connectedCallback() {
        const assetPrefix = this.getAttribute('asset-prefix') || '';
        ...
        this.innerHTML = `
            ...
            <div class="profile-card p-4 text-center">
                ...
                <div class="d-flex justify-content-center gap-3">
                    ...
                    <a class="social-link-btn text-decoration-none" href="https://discord.com/users/mayolore" target="_blank" aria-label="Discord">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
                    ...
                    <a class="social-link-btn text-decoration-none" href="https://x.com/kamrangas" target="_blank" aria-label="Twitter">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
